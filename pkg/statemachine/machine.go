...
func (fsm *StateMachine) run() {
	...
	for {
		...
		//fmt.Printf("helo 1--1 StateMachine \n")
		if atomic.CompareAndSwapInt32(&fsm.busy, 0, 1) {
			//fmt.Printf("helo 1--2 StateMachine \n")
